...
const Footer = () => {
  return (
    ...
    //         <div>
    //             <div >
    //                 <p className='text-xl font-bold text-white'>Nasa<span className='text-yellow-600'>XX</span></p>
    //                 <ul className='mt-2 space-y-2 '>
    //                     <li>
    //                         <a href="/" className='text-gray-500 transition-colors duration-300  hover:text-yellow-400'>APOD</a>
    //                     </li>
    //                     <li>
    //                         <a href="/" className='text-gray-500 transition-colors duration-300  hover:text-yellow-400'>MRP</a>
    //                     </li>
    //                     <li>
    //                         <a href="/" className='text-gray-500 transition-colors duration-300  hover:text-yellow-400'>EI</a>
    //                     </li>
    //                 </ul>
    //             </div>
    //         </div>
...
<footer 
  className="bottom-0 left-0 right-0 flex flex-col items-center bg-black text-center text-surface dark:bg-black dark:text-white">
  <div className="container px-6 pt-6">
    <div className="mb-6 flex justify-center space-x-2">
      ...
      <a
        href="https://github.com/malindu-MD"
        type="button"
  ...
  <div className="w-full bg-black/5 p-4 text-center">
    © 2024 Copyright:
    <a href="https://malindudilshan.me">malindudilshan.me</a>
  </div>
</footer>
  )
}
